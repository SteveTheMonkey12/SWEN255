...
public class Position {
	...
	public static enum Location {
		...
		CC("Calamity Castle", 2, 17, 6, 21, new Position(3, 17, null), new Position(6, 18, null), null, null), // Bottom
																												// Left
		PP("Peril Palace", 17, 17, 21, 21, new Position(18, 17, null), null, null, new Position(17, 20, null));// Bottom
																												// Right
	...
	public String toString() {
		return super.toString() + "[" + "x" + ":" + getX() + "," + "y" + ":" + getY() + "]"
				...
				+ (getLocation() != null
						? !getLocation().equals(this) ? getLocation().toString().replaceAll("  ", "    ") : "this"
						: "null");
	}
}
